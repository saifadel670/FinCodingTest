...
final class CustomModalCountryView: ModalContainerView{
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            doneButton.bottomAnchor.constraint(equalTo: dimmedView.safeAreaLayoutGuide.bottomAnchor, constant: -12),
